...
description: >-
  > **Solution for "Living" guides without review cadence**: Automated review
  date tracking and CI enforcement
---
...
- [ADR-006: Documentation Review Cadence](./adr/006-documentation-review-cadence.md) (TODO)
- [Contribution Guidelines](../CONTRIBUTING.md) - Review responsibilities
- [AI Context Maintenance](./ai-context/context-updates.md) - AI-specific reviews
