...
- **Adding a new tool:** if it reads `AGENTS.md` natively, no setup is needed. If not, add a thin overlay file that points at `AGENTS.md` (see `docs/ai-context/ai-rules-setup.md`).
