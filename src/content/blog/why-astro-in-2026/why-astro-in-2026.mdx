...
<article class="rounded-lg border border-border-primary bg-background-secondary p-6 shadow-sm">
  <h3 class="text-lg font-semibold text-foreground-primary">{title}</h3>
  <p class="mt-2 text-foreground-secondary">{description}</p>
