...
an ADR justifying it ([ADR-001](/docs/adr/001-preact-island-usage-policy/)).
...
([ADR-040](/docs/adr/040-container-api-for-component-microtests/)). Render
...
layering is established by [ADR-036](/docs/adr/036-layered-constitution/).
...
[image-optimisation defaults](/docs/adr/030-image-optimisation-defaults/)
