...
Every reusable component ships with a Container API microtest (ADR-040). Render
...
Astro `<Image />` component is the only way images render — ADR-008 forbids
raw `<img>`. The result is
