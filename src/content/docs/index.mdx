...
<Aside type="note" title="Template Reference" markdown="1">
  These docs live separately from the starter’s production build. Your cloned project already shows a clean homepage at `/`. Treat this documentation as reference material and AI context—no changes needed here.
</Aside>

<Aside type="tip" title="Live Demo" markdown="1">
  Preview the example landing page at [`/examples/landing`](/examples/landing).
</Aside>
