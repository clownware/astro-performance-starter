...
{/*TODO: Replace placeholder images. Hero (1536x1024) should be a clean diagram of the .claude/ file tree architecture. Card (600x600) should be a cropped/simplified version of the same.*/}
