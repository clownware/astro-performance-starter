 ...
 *
 * Usage:
 *   pnpm tsx scripts/src/baseline-performance.ts --url=http://localhost:4321/astro-starter-template/
 *
...
function parseArgs(): Args {
  ...
  return {
    url: urlArg ? urlArg.split("=")[1] : "http://localhost:4321/astro-starter-template/",
