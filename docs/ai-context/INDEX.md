...
1.  Consult the **[Implementation Roadmap](../README.md#implementation-roadmap)** for the full, ordered list of phases (0-12).
...
- **[Implementation Roadmap](../README.md#implementation-roadmap)** - Chronological build sequence.
