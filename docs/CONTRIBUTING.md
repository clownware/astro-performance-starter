...
## 📚 Further Reading
- [docs/meta/versions.yml](./meta/versions.yml)
- [scripts/update-versions.ts](../scripts/update-versions.ts)
- [remark-inject-versions.mjs](../remark-inject-versions.mjs)
- [ADR-000: Starter Decisions](../adr/000-starter-decisions.md)
