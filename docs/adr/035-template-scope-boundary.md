...
| Extended tutorials and walkthroughs | Docs site only (astro.clownware.org) |
...
- This policy applies to the template repository specifically. The rendered docs site at astro.clownware.org can include any content regardless of this policy.
